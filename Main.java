...
public class Main {
    ...
    private static void exercise3() {
        ...
        // Call your function
        Callings(myLunchPrice,lunchType,description,weightInGrams);

    }

    private static void celsiusFahrenheit(double celsius, double fahrenheit)
    {
    ...
    private static String conversionList(String name)
    {
    ...
    private static void Callings(double first, String second, String third, int fourth)
    {
